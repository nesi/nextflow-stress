...
# Configuration
# =============================================
TEST_DIR="/tmp"  # Change this to your Weka mount point
FILE_SIZE=100M                   # Size of test files
BLOCK_SIZES=("4k" "1M")  # Block sizes to test
THREADS=(1 16)               # Number of parallel threads to test
TEST_DURATION=15               # Duration in seconds for each test
